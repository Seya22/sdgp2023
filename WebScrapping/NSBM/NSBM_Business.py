...
html = requests.get('https://www.nsbm.ac.lk/faculty/faculty-of-business/')
...
with open('NSBM_Business.csv', 'w', newline='') as file:
...
#Writing
        ...
        Write=[degreeName[0].text,"Business","Pitipana - Thalagala Rd, Homagama","Degree",Year,details1[0]+" "+details1[1],degreeNameAff,degreeLink[x]]
        print(Write)        
...
#Writing
        ...
        Write=[degreeName[0].text,"Business","Pitipana - Thalagala Rd, Homagama","Foundation",Year,details1[0]+" "+details1[1],degreeNameAff,foundationLink[x]]
        print(Write)        
